...
{
	private double accountLimit = 1000;
        private static double ANNUAL_INTEREST_RATE = 4;
	
	public DebitAccount(String name, int id,String dob, String nominee, double balance)
	{   
